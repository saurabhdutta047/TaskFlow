...
/// and the underlying `TaskStorageServiceProtocol`. Since SwiftData uses reference
/// types for models, this repository handles the CRUD operations by delegating
/// to the storage service which manages the ModelContext directly.
final class TaskRepository: TaskRepositoryProtocol {
    ...
    /// Adds the given task to the persisted list.
    ...
    /// Updates the task with a matching `id` in the persisted list.
